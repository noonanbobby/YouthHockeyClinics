...
// ── Real South Florida rink locations ────────────────────────────────────────
...
export const SEED_RINKS: Rink[] = [
  {
    ...
    scheduleUrl: 'https://apps.daysmartrecreation.com/dash/x/#/online/warmemorial/',
  ...
  },
  {
    ...
    scheduleUrl: 'https://apps.daysmartrecreation.com/dash/x/#/online/iceden/',
...
export const ALL_SEED_SESSIONS: StickAndPuckSession[] = SEED_RINKS.flatMap(
  (r) => r.sessions,
);
